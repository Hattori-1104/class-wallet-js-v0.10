import {
	AccountantApproval,
	parseAccountantApprovalAction,
} from "~/components/page/purchase/accountant-approval"
...
const serverCommon = async ({
	...
	const isInCharge =
		...
		purchase.part.wallet.accountantStudents.some(
			(accountant) => accountant.id === student.id,
		)
